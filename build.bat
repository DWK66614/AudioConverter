...
echo [2/4] 编译主程序...
cl /nologo /EHsc /std:c++17 /O2 /W3 /utf-8 main.cpp resource.res /Fe:AudioConverter.exe /link user32.lib gdi32.lib comctl32.lib comdlg32.lib uxtheme.lib shell32.lib advapi32.lib dwmapi.lib
